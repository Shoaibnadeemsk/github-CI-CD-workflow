...
free -h
aws ec2 describe-instances --instance-ids $instance --query 'Reservations[].Instances[] | {InstanceId: InstanceId, PublicIpAddress: PublicIpAddress, SubnetId: SubnetId, InstanceType: InstanceType}'
