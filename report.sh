...
free -h
aws ec2 describe-instances --instance-ids i-06474f0e051d3c623 --query 'Reservations[*].Instances[*] | {InstanceId: InstanceId, PublicIpAddress: PublicIpAddress, SubnetId: SubnetId, InstanceType: InstanceType}'
